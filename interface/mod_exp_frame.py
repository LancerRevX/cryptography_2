...
class ModExpFrame(tk.Frame):
    def __init__(self, master):
        ...
        tk.Label(self, text='a = ').grid(column=0, row=1)
        self.a_entry = tk.Entry(self)
        self.a_entry.grid(column=1, row=1)

        tk.Label(self, text='x = ').grid(column=0, row=2)
        self.x_entry = tk.Entry(self)
        self.x_entry.grid(column=1, row=2)

        tk.Label(self, text='p = ').grid(column=0, row=3)
